...
public class RegistUserActivity extends AppCompatActivity {
    ...
    private void regist() {
        ...
        if (!"".equals(username) && !"".equals(password))
        {
            ...
            Toast.makeText(RegistUserActivity.this, "账号或者密码为空",
                    Toast.LENGTH_SHORT).show();
        }

    }
    private void Regist(String username, String password) {
        String loginUrl = "http://119.23.226.102/aibangbang/v1/users";
        new RegistUserActivity.RegistAsyncTask().execute(loginUrl, username,code, password);
    }
            ...
            if (s != null){
                try {
                    ...
                    if("200".equals(registresult)){
                        ...
                        Toast.makeText(RegistUserActivity.this,"账号或密码错误",
                ...
                Toast.makeText(RegistUserActivity.this,"账号或密码有误",Toast.LENGTH_LONG)
                        .show();
