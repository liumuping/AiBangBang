...
import com.example.administrator.controller.adapter.gerenadapter.FinishAcceptAdapter;
...
public class FinishMyacceptfragment extends BaseFragment {
    private RecyclerView recyclerview;
    private ReBang needHelp;
    private LinearLayoutManager layoutManager;
    private FinishAcceptAdapter adapter;
    ...
    protected View initView() {
        ...
        adapter = new FinishAcceptAdapter(finishList);
    ...
    private   void getNeedHelp() {
        String getUrl =" http://119.23.226.102/aibangbang/v1/help-ends/help?uid="+ MainActivity.uid;
