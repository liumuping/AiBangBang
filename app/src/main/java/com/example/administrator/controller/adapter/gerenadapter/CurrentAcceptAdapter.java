...
import com.example.administrator.controller.activity.geren.cuurent.CHacceptActivity;
...
public class CurrentAcceptAdapter extends RecyclerView.Adapter<CurrentAcceptAdapter.ViewHolder> {
    private List<ReBang> mcurrentList;
    private Context context;


    public CurrentAcceptAdapter(List<ReBang> tList) {
        mcurrentList = tList;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.finishview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, CHacceptActivity.class);
