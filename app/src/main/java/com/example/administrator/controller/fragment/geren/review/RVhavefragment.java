...
import com.example.administrator.controller.adapter.gerenadapter.ReviewHaveAdapter;
...
public class RVhavefragment extends BaseFragment {
    ...
    private ReviewHaveAdapter adapter;
    ...
    protected View initView() {
        ...
        adapter = new ReviewHaveAdapter(finishList);
