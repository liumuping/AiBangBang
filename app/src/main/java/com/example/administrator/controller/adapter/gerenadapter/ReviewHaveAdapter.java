...
import com.example.administrator.controller.activity.geren.review.RVhaveActivity;
...
public class ReviewHaveAdapter extends RecyclerView.Adapter<ReviewHaveAdapter.ViewHolder> {
    private List<ReBang> mfinishList;
    private Context context;



    public ReviewHaveAdapter(List<ReBang> finishList) {
        ...
        final ViewHolder holder = new ViewHolder(view);
            holder.finishview.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, RVhaveActivity.class);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        System.out.println("@"+needHelp.getDetails()+"@"+String.valueOf(needHelp.getEndDateTime()));
        ...
        holder.tv_rev_data.setText(needHelp.getUserComment());
        if(needHelp.getUserComment().equals("")){
            holder.ly_review.setVisibility(View.GONE);
        }
    ...
    public void removeData(int position) {
        mfinishList.remove(position);
        notifyItemRemoved(position);
        if (position != mfinishList.size()) {
            notifyItemRangeChanged(position, mfinishList.size() - position);
        }
    }
