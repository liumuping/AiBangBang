package com.example.administrator.controller.fragment.geren.current;
...
import com.example.administrator.controller.adapter.gerenadapter.CurrentApplyAdapter;
import com.example.administrator.controller.adapter.gerenadapter.WaitApplyAdapter;
...
public class CurrentApplyfragment extends BaseFragment {
    private RecyclerView recyclerview;
    private ReBang needHelp;
    private LinearLayoutManager layoutManager;
    private CurrentApplyAdapter adapter;
    private List<ReBang> currentList=new ArrayList<>();
    @Override
    protected View initView() {
        ...
        adapter = new CurrentApplyAdapter(currentList);
...
//        System.out.println("@"+""+"@");
    ...
    private   void getNeedHelp() {
        String getUrl =" http://119.23.226.102/aibangbang/v1/need-help?uid="+ MainActivity.uid+"&status=2";
            ...
            if (s != null){
                try {
                    ...
                    for (int i = 0; i <results.length() ; i++) {
                        ...
                        currentList.add(needHelp);
//                        System.out.println("@"+needHelp.getDetails()+"@");
                    }
                    recyclerview.setLayoutManager(layoutManager);
                    recyclerview.addItemDecoration(new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL));
                    adapter = new CurrentApplyAdapter(currentList);
