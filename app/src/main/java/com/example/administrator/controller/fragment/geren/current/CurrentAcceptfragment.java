...
import com.example.administrator.controller.adapter.gerenadapter.CurrentAcceptAdapter;
import com.example.administrator.controller.adapter.gerenadapter.WaitAcceptAdapter;
...
public class CurrentAcceptfragment extends BaseFragment {
    private RecyclerView recyclerview;
    private ReBang needHelp;
    private LinearLayoutManager layoutManager;
    private CurrentAcceptAdapter adapter;
    ...
    protected View initView() {
        ...
        adapter = new CurrentAcceptAdapter(currentList);
    ...
    private   void getNeedHelp() {
        String getUrl =" http://119.23.226.102/aibangbang/v1/help-currents/help?uid="+MainActivity.uid;
