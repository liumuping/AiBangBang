...
public class WaitApplyAdapter extends RecyclerView.Adapter<WaitApplyAdapter.ViewHolder> {
    private List<ReBang> mwaitList;
    private Context context;


    public WaitApplyAdapter(List<ReBang> waitList) {
        mwaitList = waitList;
    }
        ...
        final ViewHolder holder = new ViewHolder(view);
            holder.finishview.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, WHapplyActivity.class);
